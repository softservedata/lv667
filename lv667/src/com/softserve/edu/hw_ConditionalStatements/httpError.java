...
public enum httpError {
    ...
    HTTP_105(105, "Name Not Resolved"),
    ...
    HTTP_302(302, "Found"),
    HTTP_303(303, "See Other (з HTTP/1.1)"),
    HTTP_304(304, "Not Modified"),
    HTTP_305(305, "Use Proxy (з HTTP/1.1)"),
    HTTP_306(306, "Switch Proxy"),
    HTTP_307(307, "Temporary Redirect (з HTTP/1.1)"),
    HTTP_308(308, "Permanent Redirect (Experimental RFC; RFC 7238)"),
    ...
    HTTP_440(440, "Login Timeout (Microsoft)"),
    ...
    HTTP_498(498, "Token expired/invalid (Esri)"),
    ...
    httpError(int number, String description){
        this.number      = number     ;
    ...
    public void getInfo(){
        System.out.println("HTTP-"+ number + " " + description);
    }
