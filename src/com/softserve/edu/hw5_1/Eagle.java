...
public class Eagle extends FlyingBird{
    ...
    public Eagle(double wingspan,int speedFly, int flyDistance, String feathers, int layEggs) {
    ...
    public String toString() {
        return "{class Eagle: " + "wingspan=" + wingspan + ", speedFly= " + getSpeedFly() + ", flyDistance= " + getFlyDistance() + ", feathers= " + getFeathers() + ", layEggs= " + getLayEggs()+"}"+"\n";
