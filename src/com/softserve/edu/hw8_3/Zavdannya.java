...
public class Zavdannya {
    //Write class Student that provides information about the name of the student and his course.
    // Class Student should consist of properties for access to these fields constructor with parameters
    //method printStudents (List students, Integer course),
    // which receives a list of students
